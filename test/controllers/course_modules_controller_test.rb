...
class CourseModulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_module" do
    assert_difference('CourseModule.count') do
      post course_modules_url, params: { course_module: { credits: @course_module.credits, description: @course_module.description, name: @course_module.name } }
    end
  ...
  test "should update course_module" do
    patch course_module_url(@course_module), params: { course_module: { credits: @course_module.credits, description: @course_module.description, name: @course_module.name } }
